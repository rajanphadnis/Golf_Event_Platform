  ...
  db.collection("users")
    ...
    .then((searchDocs) => {
      ...
      searchDocs.forEach((doc) => {
        ...
        instance.id = doc.id;
        instance.innerHTML = `Name: ${doc.data().name}</br>Email: ${
          doc.data().email
        }</br>ID: ${doc.id}`;
      ...
      try {
        var uid = document.getElementById("listColumn").firstElementChild.id;
        document.getElementById("orgID").value = uid;
