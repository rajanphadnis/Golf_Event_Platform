...
function initTandC() {
  ...
  db.collection("admin")
      ...
      .then((adminDoc) => {
          const instance1 = document.importNode(
              document.getElementById("TandCTemplate").content,
              true
          );
          instance1.getElementById("legalAgreement").innerHTML =
              adminDoc.data().TandC;
          ...
          instance1.getElementById("legalSave").addEventListener("click", () => {
              db.collection("admin")
                  .doc("generalPageInfo")
                  .update({
                    TandC: tinymce.activeEditor.getContent(),
                  })
                  .then((f) => {
                      document.getElementById(
                          "saveStatus"
...
function initEthics() {
  ...
  db.collection("admin")
      ...
      .then((adminDoc) => {
          const instance1 = document.importNode(
              document.getElementById("ethicsTemplate").content,
              true
          );
          instance1.getElementById("legalAgreement").innerHTML =
              adminDoc.data().ethics;

          instance1.getElementById("legalSave").addEventListener("click", () => {
              db.collection("admin")
                  .doc("generalPageInfo")
                  .update({
                      ethics: tinymce.activeEditor.getContent(),
                  })
                  .then((f) => {
                      document.getElementById(
                          "saveStatus"
